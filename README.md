...
### Gem settings
    ...
    default['mongodb']['gem_version']['mongo'] # The version of the mongo gem to install (defaults to '1.9.2')
    default['mongodb']['gem_version']['bson_ext'] # The version of the bson_ext gem to install (defaults to '1.9.2')
